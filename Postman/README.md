...
+ [community.postman.com](https://community.postman.com/u/nazarrow/summary)
+ [www.chaijs.com](https://www.chaijs.com/api/)
...
+ [Artsiom Rusau QA Life. Postman для тестировщика / Тестирование API / Полный курс 2022](https://www.youtube.com/watch?app=desktop&v=zfrQtU8eCEo&feature=youtu.be)
...
## Вопросы
+ [Идем на собеседование на позицию тестировщика — 36 частых вопросов по Postman](https://testengineer.ru/postman-sobesedovanie/)
